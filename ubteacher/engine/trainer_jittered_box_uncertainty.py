...
class Trainer_jittered_box_uncertainty(UBTeacherTrainer):
    def __init__(self, cfg):
        ...
        self.uncertainty_threshold = self.cfg.SOFT_TEACHER.UNCERTAINTY_THRESHOLD
    # =====================================================
    # ================== Pseduo-labeling ==================
    # =====================================================
    def threshold_bbox(self, proposal_bbox_inst, thres=0.7, proposal_type="roih"):
        if proposal_type == "rpn":
            ...
            new_proposal_inst.gt_uncertainties = proposal_bbox_inst.pred_uncertainties[valid_map]
    ...
    def run_step_full_semisup(self):
        ...
        assert self.model.training, "[Trainer_jittered_box_uncertainty] model was changed to eval mode!"
        ...
        if self.iter < self.cfg.SEMISUPNET.BURN_UP_STEP:
            ...
            with torch.no_grad():
                (
                    ...
                    pseudo_label_with_uncertainty,
                    _,
                ) = self.model_teacher(
                    unlabel_data_k, 
                    branch="unsup_data_weak_with_uncertainty",
                    cur_threshold=self.cfg.SEMISUPNET.BBOX_THRESHOLD,
                    jittering_times=self.cfg.SOFT_TEACHER.JITTERING_TIMES,
                    jittering_frac=self.cfg.SOFT_TEACHER.JITTERING_FRAC 
                )

            #  Pseudo-labeling
            cur_threshold = self.cfg.SEMISUPNET.BBOX_THRESHOLD
            pseudo_proposals_roih_unsup_k, _ = self.process_pseudo_label(
                pseudo_label_with_uncertainty, cur_threshold, "roih", "thresholding"
            )
            joint_proposal_dict = {}
            ...
            record_all_unlabel_data, _, _, _ = self.model(
                all_unlabel_data, 
                branch="supervised_with_uncertainty",
